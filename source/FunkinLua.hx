	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "makeGraphic", function(obj:String, width:Int, height:Int, color:String) {
			...
			if(object != null) {
                ...
                Lua_helper.add_callback(lua, "addVirtualPad", function(Pad:String, Button:String) {
			var padNum:Int = Std.parseInt(Pad);
                        var buttNum:Int = Std.parseInt(Button);

			addVirtualPad(padNum, buttNum);
		});
